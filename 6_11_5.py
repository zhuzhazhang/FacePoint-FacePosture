...
l1 = add_layer(xs, 10, 20, activation_function=tf.nn.tanh)
# add output layer 输入值是最后一层隐藏层
prediction = add_layer(l1, 20, 3, activation_function=None)
...
for i in range(20001):
    ...
    if i % 1000 == 0:
        saver.save(sess, './6_11_5/Model.ckpt', global_step=i)
